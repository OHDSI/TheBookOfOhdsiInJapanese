...
```{r conceptSet, fig.cap='「心筋梗塞」（子孫を含む）を含むが、「古い心筋梗塞」（子孫を含む）を除外する概念セット。',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r ATLASdrugexposure, fig.cap='薬物曝露の定義', echo=FALSE, out.width='100%', fig.align='center'}
...
```{r EarliestEventExplained, fig.cap='基準の適用による患者の資格の説明', echo=FALSE, out.width='100%', fig.align='center'}
