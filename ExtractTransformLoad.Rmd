...
マップする適切な概念を探す場合、概念の「社会的生活」を考慮することが重要です。ある概念の意味は、その概念の階層における位置に部分的に依存することがあります。また、語彙の中には、階層的な関係がほとんどない、あるいは全くない「孤児概念」が存在することがあり、それらはターゲット概念としては適していません。また、ALT + Cキーを押すか、上部メニューバーのview -\> Concept informationを選択することで、より多くの情報を表示することができます。
