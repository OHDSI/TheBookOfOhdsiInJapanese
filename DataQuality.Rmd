...
```{r testFramework, fig.cap='Rabbit-in-a-Hatテストフレームワークを使用したETL（抽出-変換-読込）プロセスの単体テスト',echo=FALSE, out.width='90%', fig.align='center'}
...
```{r missingMapping, fig.cap='孤立したソースコードの例',echo=FALSE, out.width='70%', fig.align='center'}
...
```{r achillesDataDensity, fig.cap='ACHILLESウエブビューワーでのデータ密度プロット',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r achillesCodeChange, fig.cap='ACHILLESウエブビューワーでの月次糖尿病の診断コードの有病率',echo=FALSE, out.width='100%', fig.align='center'}
