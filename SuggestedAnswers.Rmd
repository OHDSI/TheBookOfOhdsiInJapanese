...
```{r cohortsAtlasInitialEvents, fig.cap='ジクロフェナクの新規ユーザーのコホート・エントリー・イベント設定',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r cohortsAtlasConceptSet1, fig.cap='ジクロフェナクのコンセプトセット',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r cohortsAtlasInclusion1, fig.cap='NSAID曝露の履歴がないことの要求',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r cohortsAtlasConceptSet2, fig.cap='NSAIDsのコンセプトセット',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r cohortsAtlasInclusion2, fig.cap='以前にがんの診断がないことの要求',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r cohortsAtlasConceptSet3, fig.cap='広範な悪性腫瘍のコンセプトセット',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r cohortsAtlasExit, fig.cap='コホート・イグジット日の設定',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r dataSourcesAtlas, fig.cap='データソースの特性の評価',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r conceptSearchAtlas, fig.cap='成分「Celecoxib (セレコキシブ)」の標準コンセプトの選択',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r celecoxibCohortDefinition, fig.cap='セレコキシブ新規ユーザーの単純なコホート定義',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r celecoxibCharacterization, fig.cap='特性評価設定',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r celecoxibCharacterizationResults, fig.cap='特性評価の結果',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r giBleedSearch, fig.cap='「Gastrointestinal hemorrhage (消化管出血)」の標準コンセプトの選択',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r giBleedDescendants, fig.cap='「Gastrointestinal hemorrhage (消化管出血)」のすべての下位層を追加',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r irAnalysis, fig.cap='発生率の分析',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r irResults, fig.cap='発生率の結果',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r plpShiny, fig.cap='Shinyアプリによる患者レベルの予測の表示',echo=FALSE, out.width='100%', fig.align='center'}
