...
```{r cohortsAtlasConceptSet1, fig.cap='ジクロフェナクの概念セット表現。',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r cohortsAtlasConceptSet2, fig.cap='NSAIDsの概念セット表現',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r cohortsAtlasConceptSet3, fig.cap='広範な悪性腫瘍の概念セット表現',echo=FALSE, out.width='100%', fig.align='center'}
