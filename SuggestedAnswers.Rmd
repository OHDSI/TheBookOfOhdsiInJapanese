...
```{r cohortsAtlasInitialEvents, fig.cap='ジクロフェナクの新規ユーザーのコホート組入れ・エントリー・イベント設定',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r cohortsAtlasExit, fig.cap='コホート離脱日の設定',echo=FALSE, out.width='100%', fig.align='center'}
