...
```{r covariateSettings4, fig.cap='期間時間共変量.', echo=FALSE, out.width='100%', fig.align='center'}
...
```{r covariateSettings5, fig.cap='時間制約共変量',echo=FALSE, out.width='100%', fig.align='center'}
...
```{r covariateSettings6, fig.cap='リスクスコア共変量設定',echo=FALSE, out.width='100%', fig.align='center'}
