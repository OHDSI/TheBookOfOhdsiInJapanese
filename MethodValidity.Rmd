...
<<<<<<< HEAD
: (#tab:exampleMetrics) ネガティブおよびポジティブコントロールの推定値から導出されたメソッドのパフォーマンス指標。

カバー率と第1種の過誤は、それぞれ95%と5%という公称値に非常に近い値であり、AUCは非常に高い値であることがわかります。 しかし、これは常に当てはまるわけではありません。
=======
...
>>>>>>> 1d1966c09a38f43467776b894ff58199dde67652
